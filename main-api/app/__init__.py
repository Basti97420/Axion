...
def create_app():
    ...
    from .models import user, project, issue, tag, worklog, comment, activity, calendar_entry, milestone, attachment, user_settings, wiki_page, wiki_attachment, ki_agent, python_script  # noqa: F401
